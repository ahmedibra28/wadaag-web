...
export const eTemplate = (props: EmailProps) => {
  return `
    ...
    >
      <span
        ...
        style="
          ...
          overflow: hidden;
        "
        >Use this link to reset your password. The link is only valid for ${props?.validTime}.</span
      >
      <table
        class="email-wrapper"
        width="100%"
            ...
            >
                      ...
                      >
                        <div class="f-fallback">
                          ...
                          >
                            ...
                            ${props?.webName} account. Use the button below to reset
                            it.
                            <strong
                              >This password reset is only valid for the next ${props?.validTime}.</strong
                            >
                          </p>
                          <!-- Action -->
                          <table
             ...
             https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                          ...
                          >
                            ...
                            ${props?.osName} device using ${props?.clientName}. If
                          ...
                          <p
                            ...
                            "
                          >
                            Thanks, <br />The ${props?.webName} Team
                          </p>
                          <!-- Sub copy -->
                          <table
                            class="body-sub"
                  ...
                  >
                    <tr>
                      ...
                      >
                        ...
                        >
                          ${props?.webName}
                          <br />${props?.addressStreet}. <br /> ${props?.addressCountry}
                        </p>
                      </td>
                    </tr>
                  </table>
